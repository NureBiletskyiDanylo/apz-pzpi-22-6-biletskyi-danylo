...
14	Sekiro	FromGa	Some desc	40	20	40	20
\.
...
6	1	S-6669	100	1
22	1	s231	100	1
25	0	S-123a	-11.352453	1
1	0	s-1	2.077508	1
4	0	S-3827	-3.155341	1
\.
...
SELECT pg_catalog.setval('public.batches_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.sensors_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.storage_violations_id_seq', 148, true);
...
SELECT pg_catalog.setval('public.warehouses_id_seq', 19, true);
