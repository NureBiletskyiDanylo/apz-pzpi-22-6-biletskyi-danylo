...
6	1	S-6669	100	1
22	1	s231	100	1
25	0	S-123a	-2.968817	1
1	0	s-1	45.179344	1
4	0	S-3827	6.825281	1
\.
...
SELECT pg_catalog.setval('public.batches_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.sensors_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.storage_violations_id_seq', 193, true);
...
SELECT pg_catalog.setval('public.warehouses_id_seq', 20, true);
